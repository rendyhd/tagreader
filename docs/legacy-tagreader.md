# Legacy upstream instructions

These apply to `tagreader.yaml`, not Movie Time. For your case player use
[Movie Time setup](movie-time-setup.md). Original upstream text follows.
...
![Photos of the final product](cases.jpg)
...
![Open Case](inside-case-completed.jpg)
